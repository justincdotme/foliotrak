...
{
    /** Days for baseline and recent windows. */
    private const WINDOW_DAYS = 28;

    /** Fractional tolerance for considering cadences equal. */
     ...
     * @param integer      $healthSampleSize
     * @param string       $basis
     * @param integer|null $baseline
     * @param integer|null $recent
