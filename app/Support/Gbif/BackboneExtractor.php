...
class BackboneExtractor
{
     ...
     *
     * @return integer number of species written
     */
    ...
    /**
     * Parse meta.xml to extract core and vernacular extension descriptors.
     *
     * @param string $archivePath
     *
    ...
    /**
     * Extract the location, separator, key index, and field map from an element.
     *
    ...
    /**
     * Map fields needed for filtering the core table.
     *
    ...
    /**
     * Build a set of GBIF keys that qualify for export.
     *
     * @param string                        $archivePath
     * @param array<string, mixed>          $core
    ...
    /**
     * Collect English vernacular names for qualifying taxa.
     *
     * @param string               $archivePath
    ...
    /**
     * Write the compressed seed file line by line.
     *
     * @param string                        $archivePath
     * @param array<string, mixed>          $core
     * @param array<string, int|null>       $plan
    ...
    /**
     * Check if a row qualifies and return its key and rank.
     *
    ...
    /**
     * Stream rows from a TSV file inside the archive.
     *
     * @param string               $archivePath
    ...
    /**
     * Get a cell value by column index, with bounds safety.
     *
     * @param list<string> $row
    ...
    /**
     * Parse a GBIF key from a string.
     *
     * @param string $raw
     *
     * @return integer|null
    ...
    /**
     * Unicode normalization and trim.
     *
     * @param string $value
     *
     * @return string
    ...
    /**
     * Decode escaped field separator.
     *
     * @param string $raw
     *
     * @return string
    ...
    /**
     * Extract a named file from the archive.
     *
     * @param string $archivePath
     * @param string $name
     *
    ...
    /**
     * Strip namespace prefix from XML node name.
     *
    ...
    /**
     * Extract the local name from a Darwin Core term URI.
     *
     * @param string $term
     *
     * @return string
