...
The original decision rejected `/species/search` because it cannot correct misspellings (validated against typo queries). That remains true for its stated purpose.
